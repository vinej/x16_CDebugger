...
vel_y dc.w $00C0
    ...
    SUBROUTINE
hit        dc.b 0              ; overlapping the box this frame?
    SUBROUTINE
hit_prev   dc.b 0              ; ...and last frame, for edge detection
    SUBROUTINE
blip_timer dc.b 0              ; frames left in the PSG envelope
    SUBROUTINE
box_i      dc.b 0              ; draw_box loop counter

    SUBROUTINE
msg_hit  dc.b "HIT  FRAME ", $00
    SUBROUTINE
msg_miss dc.b "---  FRAME ", $00
